				...
				<div className="bg-[#f4fbf8] p-8 md:p-12">
					...
					<form onSubmit={handleSubmit(onSubmit)} className="mt-6 space-y-4">
						<div>
							...
							<input
								{...register("email")}
								className={`mt-1 block w-full px-3 py-2 bg-[#daede9] border border-[#cbd1d0] rounded-md shadow-sm placeholder:text-slate-400 text-slate-100 transition-all duration-200 ease-in-out focus:border-[#2a2a2a] focus:ring-1 focus:ring-[#e9632c] ${errors.email ? "ring-1 ring-rose-500" : ""}`}
